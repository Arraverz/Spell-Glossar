...
export default {
  ...
  beforeDestroy() {
    if (this.$refs.vstooltip.parentElement == document.body) {
      document.body.removeChild(this.$refs.vstooltip)
    }
  },
  methods: {
    mouseenterx() {
